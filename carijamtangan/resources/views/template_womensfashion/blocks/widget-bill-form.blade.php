						...
						<form method="post" class="colorlib-form">
		              	...
		              	<div class="row">
						    ...
						    <div class="col-md-12">
			                    	...
			                    	<input type="text" maxlength="13" pattern="([0-9]|[0-9]|[0-9])" id="telphone" class="form-control" placeholder="Contoh : 081385800400">
			                  </div>
			               </div>
			                   <div class="col-md-12">
									<div class="form-group">
										<label for="numberphone">Email </label>
			                    	<input type="email" id="email" class="form-control" placeholder="Contoh : emailkamu@gmail.com">
			                  </div>
			               </div>
